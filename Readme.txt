...
MODULE_HEISENBERG has two parts. All the codes except those in Inside_WAM are meant to run on a Personal Computer. Short descriptions of these codes are provided below:
