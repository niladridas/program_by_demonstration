...
int flag = 0;
int max_obj_found = 0;
bool flag_obj1, flag_obj2, flag_obj3, flag_obj4, flag_obj5, flag_obj6, flag_obj7, flag_obj8;
   ...
   void save_cloud()
	{
	   ...
	   for(int k = 0 ; k < Markers.size(); k++)
	   {
		   ...
		   f1 <<  Markers[k].id << " " << Centre_in_robot(0) << " " << Centre_in_robot(1) << " " <<  Centre_in_robot(2) << " " << angle << std::endl;
