...
//	myReadFile.close();
	...
	{
		//std::cout << "No solutions are possible" << endl;
	}
	...
	//std::cout << "take as input the resolution in degrees: " << endl;
	resolution =  0.01;
	...
	int search_size = int((upper_bound_degrees - lower_bound_degrees)/resolution);
	 ...
	 //std::cout << " search_size " << search_size << endl;
...
for(int i = 0; i < sol_counter; i++)
{
	...
	//std::cout << "sol_counter  " << sol_counter << endl;
//	//std::cout << final_joint_angles << " " << endl;
	//std::cout << final_joint_sol << " " << endl;
...
//	  file_joint_positions.close();
	...
	//	//std::cout << "theta_2_out " << theta_2_out*180/pi << " " << "theta_4_out " << theta_4_out*180/pi << " " << "theta_6_out "  << theta_6_out*180/pi << endl;

	// //std::cout << "exmaple " << int(10.3) << endl;

		  //std::cout << "Calculated jopint POsitions"  << endl;
		  strcpy (fileName,tmpFile);
std::cout << "Returned from func multi sol with solution = "<< sol_counter <<" And File NAme = "<< fileName <<std ::endl;
	return ;
}
