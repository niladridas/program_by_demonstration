...
//
	 ...
	 ifstream myReadFile;
	 myReadFile.open("/home/niladri-64/plc_kinect_workspace/robot/end_effector_cartesian.txt");
	 float output[9];
	 for(int i =0 ; i<9; i++)
	 {
		 myReadFile >> output[i];
	...
	////////////////////
	  ...
	  std::ifstream infile("/home/niladri-64/plc_kinect_workspace/robot/phi_search.txt");
...
//	cout << final_joint_angles << " " << endl;
	cout << final_joint_sol << " " << endl;
	  ...
	  std::ofstream file_joint_positions("/home/niladri-64/plc_kinect_workspace/robot/joint_positions.txt");
