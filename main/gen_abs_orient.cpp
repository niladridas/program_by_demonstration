...
int main()
{
	...
	ifstream file;
	file.open( "/home/niladri-64/plc_kinect_workspace/robot/input_cordinates_for_trans.txt");
	MatrixXf Y(3,4);
	MatrixXf X(3,4);
	float dummy;
...
std::ofstream file_to_save("/home/niladri-64/plc_kinect_workspace/robot/translation_matrix.txt");
