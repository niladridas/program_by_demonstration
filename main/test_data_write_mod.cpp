...
//	ofstream file; // out file stream
	file.open("/home/niladri-64/plc_kinect_workspace/robot/robot_cordinates1.txt");
	file_camera.open("/home/niladri-64/plc_kinect_workspace/robot/camera_cordinates.txt");
